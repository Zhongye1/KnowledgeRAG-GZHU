      ...
      <FlatList
        ...
        ListHeaderComponent={
          knowledgeBases.length > 0 ? (
            <Text style={styles.listHeader}>{knowledgeBases.length} 个知识库</Text>
          ) : null
        }
        ListEmptyComponent={
          !loading ? (
            <View style={styles.empty}>
              ...
              <Text style={styles.emptyDesc}>点击右上角「+」创建第一个知识库</Text>
            </View>
          ) : null
        }
        refreshControl={
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalSheet}>
            ...
            <TextInput
              ...
              autoFocus
            />
            <Text style={[styles.fieldLabel, { marginTop: 12 }]}>描述（可选）</Text>
            <TextInput
